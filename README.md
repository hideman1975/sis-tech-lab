Тестовое задание от компании "Лабаратория Системных Технологий".
...
Выполнено в виде JavaScript проекта. Запуск тестов из паки проекта командой - npm test
В качестве кодирования чисел использованы ASCII символы.
